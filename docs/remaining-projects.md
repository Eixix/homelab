...
| --- | --- | --- | --- | --- | --- |
| Mealie | `mealie` | `https://food.home` | Running | `/docker-compose-services/mealie-data` | Port into this repo if it remains a family service; it is a simple single-container internal app. |
